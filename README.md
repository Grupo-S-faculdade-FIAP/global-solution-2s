...
- **`docs/`**: Documentação do projeto — índice em [docs/README.md](docs/README.md).
  ...
  - **Retreino YOLO:** `make train-yolo` (pipeline canônico) · pesos em `src/models/weights/best.pt` e no S3 (`YOLO_MODEL_PATH`)
...
- **Vídeo de demonstração (5min):** https://www.youtube.com/watch?v=W67760WVado
