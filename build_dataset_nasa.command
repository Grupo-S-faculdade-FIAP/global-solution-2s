...
echo "  Próximo passo: make train-yolo"
echo "  (ou: python3 src/yolo_training.py --epochs 40 --batch 8 --recall-focus)"
echo "  Pesos após treino: src/models/weights/best.pt"
echo "================================================"
echo ""
